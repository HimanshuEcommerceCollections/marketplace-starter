...
export interface CorporateInquiryPageProps {
  config: CorporateInquiryConfig;
}

/**
 * Corporate proposal-request page (/corporate/inquiry) — the funnel target of
 * the Corporate landing's CTA. A shared full-bleed hero (.ssp-hero* + .hero-*),
 * a stub inquiry form with a "what happens next" sidebar, and a stats band.
 */
export function CorporateInquiryPage({ config }: CorporateInquiryPageProps) {

...
// Re-fetch the live service config periodically so admin edits (goal cards,
...
const page = getShowcasePage("nutrition-coaching");
...
/**
 * Bespoke, GSAP-animated Nutrition Coaching landing page built on the shared
 * service showcase template. Editorial copy comes from nutrition.config.ts;
 * all booking options (goal cards, price tiers) are resolved live from the
 * service config API. This static segment takes precedence over the generic
 * /services/[slug] route.
 */
